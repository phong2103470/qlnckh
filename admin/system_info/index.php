	...
	<div class="card card-outline card-primary">
		...
		<div class="card-body">
			...
			<div class="form-group">
				<label for="ten" class="control-label">Tên hệ thống</label>
				<input type="text" class="form-control form-control-sm" name="ten" id="ten" value="<?php echo $_settings->info('ten') ?>">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="content[about_us]" class="control-label">Giới thiệu</label>
			...
			<div class="form-group">
				<label for="content[about_us]" class="control-label">Thông tin</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Bìa hệ thống</label>
				<div class="custom-file">
			...
			<fieldset>
				...
				<div class="form-group">
					<label for="contact" class="control-label">SĐT</label>
	...
	function displayImg(input,_this) {
	    if (input.files && input.files[0]) {
	        ...
	        reader.onload = function (e) {
	        	...
	        	_this.siblings('.custom-file-label').html(input.files[0].ten)
	        }
