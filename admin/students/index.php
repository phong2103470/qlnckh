        ...
        <div class="container-fluid">
			<table class="table table-hover table-striped">
				...
				<tbody>
					<?php 
						$i = 1;
						$qry = $conn->query("SELECT * from `sinhvien`  order by mssv asc ");
					...
					?>
						<tr>
							...
							<td><?php echo ucwords($row['mssv']) ?></td>
							<td><?php echo ucwords($row['nganh_khoa']) ?></td>
...
<script>
	$(document).ready(function(){
		...
		$('.view_details').click(function(){
			uni_modal('Thông tin sinh viên',"students/view_details.php?id="+$(this).attr('data-id'),'mid-large')
		})
		$('.table').dataTable();
