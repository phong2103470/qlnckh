...
<div class="h-100 d-flex  align-items-center w-100" id="login">
    <div class="col-7 h-100 d-flex align-items-center justify-content-center">
      <div class="w-100">
        ...
        <h1 class="title"><b><?php echo $_settings->info('ten') ?></b></h1>
      </div>
        ...
        <div class="w-100 d-flex justify-content-center align-items-center h-100 text-navy">
            <div class="card card-outline card-primary rounded-0 shadow col-lg-10 col-md-10 col-sm-5">
                <div class="card-header">
                    <h5 class="card-title text-center text-dark"><b>Đăng nhập </b></h5>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group text-right">
                                    <button class="btn btn-default bg-navy btn-flat">Đăng nhập</button>
                                </div>
                            </div>
                        </div>
                    </form>
